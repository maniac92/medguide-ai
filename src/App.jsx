...
@media(min-width:768px){.app{max-width:720px;box-shadow:0 0 40px rgba(15,118,110,.08);border-left:1px solid var(--bl);border-right:1px solid var(--bl)}}
...
@media(min-width:768px){.tab-bar{max-width:720px}}
